...
const body = [
  ...
  "3. The app is not notarized, so macOS blocks the first launch. Open it anyway:",
  "   right-click the app and choose **Open**, or open it once, then go to",
  "   **System Settings → Privacy & Security**, scroll down and click **Open Anyway**.",
  "4. Choose Always Allow when macOS asks about the Keychain. That is how it reads your Claude Code login.",
  "",
  "If macOS says the app is *damaged*, the download predates this release. Take the",
  "quarantine flag off and it will open:",
  "",
  "```sh",
